...
class Frontend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        $third = Db::name('config')
            ->whereIn('name',['facebook','twitter','behance','youtube','linkedin_in'])
            ->column('value','name');
        ...
        $oneCategoryList  = $categoryModel[0];
        $twoCategoryList  = $categoryModel[1];
        ...
        $bannerInfo = Db::name('nav')
            ->column('title,description,content,cover','typedata');
