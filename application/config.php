...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'JWtgYdp4T8BoNuznLjblxivZePw96Iak',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'paypal'=>[
        'client_id'=>'AblO0r95LtYofvhX0hmdBZQMQrh6ZmofgPvQjNNGkmjLZ1GT-Y7rfLzjygxUoObu7y_T4d8eES0yWNTc',
        'client_secret'=>'EDKJ5_KlIRtD2RAyocd0irk23gpQeeGtczhQd5dp_zOClxmFATcE-StbqrD_NnmTpB1FWj5mlHJHMA3V',
    ],
];
